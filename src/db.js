...
sequelize
  ...
  .then(async () => {
    ...
    let arrProject = [
      {
        title: "pala",
        summary: "necesito pala",
        description: "mi descripcion del proyecto",
        goal: 600,
        img: "algo",
        userId: "",
        category: ["emprendimiento", "educacion"],
      },
      {
        title: "palita",
        summary: "necesito palita",
        description: "mi descripcion del proyecto",
        goal: 213,
        img: "algo",
        userId: "",
        category: ["emprendimiento", "medicina"],
      },
      {
        title: "pico",
        summary: "necesito un pico",
        description: "mi descripcion del proyecto",
        goal: 1200,
        img: "algo",
        userId: "",
        category: ["emprendimiento", "ambiental"],
      },
    ];
