...
const { getProjects, postProject, detailProject, updateProjectHl, deleteProjectHl, updateValidateHl, getAllFilteredProjects, getAllProjecstAdminHl } = require('../controllers/project/projectHandler')
